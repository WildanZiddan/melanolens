'use client' // Kita paksa pake client component dulu biar aman dari server actions
...
// 🚀 KITA BIKIN DATA MOCK LOKAL BIAR GAK USAH IMPORT DARI SERVER ACTIONS YANG HILANG
