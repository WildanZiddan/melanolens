            ...
            <div className="flex flex-col min-h-screen pt-20 md:pt-40 relative overflow-hidden">
                <div>
                    <TextGenerateEffect
                        ...
                        words="Deteksi Dini Melanoma dengan Teknologi AI"
                    ...
                    <motion.p
                        ...
                        className="text-center mt-6 text-base md:text-xl text-muted dark:text-white max-w-5xl mx-auto relative z-10 font-normal"
                    >
                        Unggah citra dermoskopi Anda dan dapatkan analisis instan berbasis Computer Vision. Solusi cerdas untuk membantu pemantauan kesehatan kulit secara mandiri
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0, translateY: 40 }}
                        animate={{ opacity: 1, translateY: 0 }}
